...
define(['jquery', 'underscore', 'handlebars', 'backbone', '/built/assets/scripts/app/customers/view_item.js', 'text!./templates/form.html'], function($, _, Handlebars, Backbone, ViewItem, EditForm) {
  var View;
